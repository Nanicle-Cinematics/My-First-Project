...
async function renderDashboard(db, user) {
  ...
  const hero = `<section class="dashboard-welcome">
    ...
    <div class="welcome-actions">
      ...
      <a class="btn primary" href="/members/new">Add member <span>${icon('plus')}</span></a>
    </div>
  </section>`;
  ...
  const quickLinks = `
    <section class="dashboard-section">
      ...
      <a class="report-tile" href="/members"><div class="ico">${icon('members')}</div><div><div class="name">Members</div><div class="desc">${totalMembers} total</div></div></a>
      <a class="report-tile" href="/events"><div class="ico">${icon('events')}</div><div><div class="name">Events</div><div class="desc">${upcomingEvents.length} upcoming</div></div></a>
      <a class="report-tile" href="/finance"><div class="ico">${icon('finance')}</div><div><div class="name">Finance</div><div class="desc">${fundCount} funds</div></div></a>
      <a class="report-tile" href="/bible-classes"><div class="ico">${icon('book')}</div><div><div class="name">Bible Classes</div><div class="desc">${ministryCount} classes</div></div></a>
      <a class="report-tile" href="/organizations"><div class="ico">${icon('organizations')}</div><div><div class="name">Organizations</div><div class="desc">${orgCount} groups</div></div></a>
      <a class="report-tile" href="/reports"><div class="ico">${icon('reports')}</div><div><div class="name">Reports</div><div class="desc">Day-born, income, members</div></div></a>
    </div></section>`;
